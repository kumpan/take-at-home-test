...
Create application using Google Maps API, which lets the user save interesting places the user wants to visit in Stockholm. You decide on the design.

## Requirements
- Use react and [hooks](https://reactjs.org/docs/hooks-intro.html)
...
* Commit often! We want to see how you come up with your solution.
